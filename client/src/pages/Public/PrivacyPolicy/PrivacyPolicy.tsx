  ...
  return (
    <>
      <Helmet>
        ...
        <title>Politiques de confidentialité | {WEBSITE_NAME}</title>
      </Helmet>
      <section className={classes.Container}>
        <Heading tag="h1">Politique de confidentialité</Heading>
        <Heading tag="h2">Liens hypertextes et cookies</Heading>
        <p>
          Le site www.brownskinbeauty.fr contient un certain nombre de liens hypertextes vers
          d’autres sites (partenaires, informations …) mis en place avec l’autorisation du
          propriétaire du site. Cependant, le propriétaire du site n’a pas la possibilité de
          vérifier le contenu des sites ainsi visités et décline donc toute responsabilité de ce
        ...
        <p>
          Elles sont destinées à tout gérant/employé de l’établissement susceptible d’avoir un
          échange téléphonique ou par messagerie électronique avec les personnes concernées,
          notamment pour répondre à leur demande.
        </p>
        <p>
          Aucune adresse IP n’est collectée lors de l’envoi d’un formulaire par le biais de notre
          site Internet.
        </p>
        <p>
        ...
        <p>
          Aucune information personnelle de l’utilisateur du site www.brownskinbeauty.fr n’est
          publiée à l’insu de l’utilisateur, échangée, transférée, cédée ou vendue sur un support
          quelconque à des tiers. Seule l’hypothèse du rachat du site www.brownskinbeauty.fr au
          propriétaire du site et de ses droits permettrait la transmission des dites informations à
          l’éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et
          de modification des données vis à vis de l’utilisateur du site www.brownskinbeauty.fr.
        </p>
        <p>
